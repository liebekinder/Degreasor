#include "mywidgetforwidget.h"

MyWidgetForWidget::MyWidgetForWidget(Controleur *control, QWidget *parent) :
    QScrollArea(parent)
{
    this->controler = control;
}

void MyWidgetForWidget::mousePressEvent(QMouseEvent *event)
{
